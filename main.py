...
while is_program_running:
    selection = input("Type 'm' to convert text to morse code or type 't' to convert morse code to text: ")
    if selection == 'm':
        ...
        continue
    if input("Would you like to encode or decode again? 'y' or 'n': ") == "y":
        continue
    else:
        break
